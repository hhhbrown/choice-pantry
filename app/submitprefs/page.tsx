                ...
                <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-sm border border-zinc-200">
                    ...
                    <div className="rounded-xl bg-white p-4">
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border px-4 py-3 placeholder-zinc-600 text-black"
                        />

                        <button
                            onClick={handleAddCustom}
                            className="mt-3 w-full rounded-lg border border-zinc-300 bg-white px-4 py-3 text-black"
                        >
                            Add
                        </button>
